...
rdd = sc.textFile("hdfs://namenode:9000/project/spark_hadoop/wordcount/data/shakespeare.txt",8)\
...
stop_words = sc.textFile("hdfs://namenode:9000/project/spark_hadoop/wordcount/data/stopwords.txt")
